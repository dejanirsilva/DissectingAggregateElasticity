...
The endowment growth rate $\mu=1.8\%$ and endowment volatility $\sigma=3.3\%$ are calibrated to be consistent with the U.S. aggregate consumption data (\citealp{campbell1999force}).
Following \citet{LettauWachter2011}, we set the correlation of dividend-share shocks with the fundamental at $0.3$ and the dividend-share volatility at $\sigma_s=11\%$.
The mean-reversion of the dividend share is $\kappa_s=0.09$, following \cite{santos2006labor}.
The mean dividend share is set at $\bar{s}=0.6$, implying a debt-to-equity ratio of 0.67, consistent with \cite{abel1999risk}.
...
%\footnote{Price impact in the model is $d\log(P/D)/d\overline{\alpha}_p$. \citet{gabaix2020search} estimate a multiplier of roughly $5$, while \citet{Hartzmark/Solomon/2021} estimate $1.9$. Averaging the two gives $3.45$, and scaling by the passive share of roughly one half yields $3.45\times 2\approx 6.90$.}
