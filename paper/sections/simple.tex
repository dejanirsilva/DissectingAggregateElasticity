...
Let $\overline{\alpha}_p^\star$ denote the passive portfolio share in the initial equilibrium, with $(p^\star, r^\star)$ the corresponding equilibrium prices.

For a small perturbation, $\overline{\alpha}_p = \overline{\alpha}_p^\star e^{\hat{\alpha}_p}$, we linearize demand around the initial equilibrium.
Defining $\hat{p}\equiv p-p^\star$, $\hat{r}\equiv r-r^\star$, and $q_j \equiv \log(Q_j/Q_j^\star)$, we obtain
...
Let $s_j \equiv \omega_j Q_j^\star$ denote the equilibrium quantity share of the risky asset held by type $j$.
