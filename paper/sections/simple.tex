...
Linearizing the goods-market condition $\overline{c}(\mu-p)=1/(1+e^{p})$ around $p^*$ yields
...
In the goods market (right panel of Figure~\ref{fig:mkt_equilibrium}), the price-dividend ratio is determined by consumption behavior.
...
When the flow shock shifts both the net-supply curve and the average consumption-wealth ratio, prices adjust and aggregate elasticity becomes finite.\footnote{An analogous argument applies to uncertainty.
