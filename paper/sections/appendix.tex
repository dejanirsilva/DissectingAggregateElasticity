...
\begin{proof} We consider next the first-order correction terms. 
    ...
    \begin{equation}
        d \overline{\alpha}_{p,t} = \kappa_p (\overline{\hat{\alpha}} - \hat{\alpha}_{p,t}) \epsilon dt + \sigma_p \epsilon dZ_t,
    \end{equation}
    where $\overline{\alpha} = 1 + \overline{\hat{\alpha}}\epsilon$, so the process for $\hat{\alpha}_{p,t}$ is independent of $\epsilon$.
...
\end{equation}
where $\hat{\nu}_{j} = 0$ for an unconstrained active investor.
