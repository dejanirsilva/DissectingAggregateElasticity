...
The HJB loss in the first-stage training problem converges to a mean-squared loss of $3.7 \times 10^{-8}$. The corresponding valuation-ratio training problems converge to a mean-squared training loss of $1.4 \times 10^{-5}$. These losses are computed from the batch objectives in \eqref{eq:baseline_batch_loss_appendix} and in the valuation-ratio objective, respectively. 
