...
\end{align}
subject to $\alpha_j \in \Omega_j$ and $\sigma_{j} = \alpha_j^\top \Sigma$.
...
\begin{align}
    ...
    V_{j,W} \pi &= - V_{j,WW} W_j \Sigma \Sigma^\top \alpha_j -  \Sigma (V_{j,WX} \sigma_X)^\top.
\end{align}
...
\begin{equation}
\sigma_j = \min \left\{ -\frac{V_{j,W}}{V_{j,WW} W_j}  \lambda_j   - \frac{V_{j,WX}}{V_{j,WW} W_j} \sigma_X, \overline{\sigma}_j\right\},
\end{equation}
using the fact that $\pi = \Sigma \lambda^\top$, and setting $\overline{\sigma}_j = \infty$ for the unconstrained investor
...
\begin{equation}
    \sigma_{j,t}
    = \min \left\{ \frac{\lambda_t}{\gamma_j}  - \frac{1-\gamma_j^{-1}}{1-\psi} \sigma_{\xi_j,t} , \overline{\sigma}_j\right\}.
\end{equation}
