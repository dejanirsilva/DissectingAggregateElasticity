...
\subsection{The reduced system of PDEs and the mutual fund theorem}
...
\subsubsection{Reduced system of PDEs}
...
Lemma~\ref{lemma:mutual_fund_theorem} and its corollary show that the consumption-wealth ratio and price-dividend ratio of the aggregate claim are independent of the dividend share $s$.
