...
\paragraph{Drift and diffusion of price-dividend ratio.} The drift of $p_{Y,t}$ is given by
\begin{equation}
...
The price-dividend ratio is given by
\begin{equation}
    p_{Y}(x, \overline{\alpha}_p) = p_{Y,2}(x, \hat{\alpha}_p)\epsilon^2 + \mathcal{O}(\epsilon^3),
\end{equation}
...
\begin{equation}
    q_{j,t} = \frac{\eta_t \sigma^\top}{\gamma \|\sigma\|^2} + \frac{1-\gamma^{-1}}{\psi-1} \frac{\sigma_{c_j,t} \sigma^\top}{\|\sigma\|^2}+ \mathcal{O}(\epsilon^3).
\end{equation}
...
\begin{equation}
    q_{j} = -\frac{p_{Y,2}\epsilon^2}{p_{Y,0}^2 \gamma \|\sigma\|^2} - \frac{r_1\epsilon + r_2\epsilon^2}{\gamma \|\sigma\|^2} + \left[ \mu_{p_Y,2} +(1-\gamma) \sigma \sigma_{p_Y,2}^\top \right]\epsilon^2 + \mathcal{O}(\epsilon^3).
\end{equation}
...
\begin{equation}
    f_{j,t} = \mu_{p_Y,t} + (1-\gamma) \sigma \sigma_{p_Y,t}^\top.
\end{equation}

The demand for the risky asset for passive investors takes the same form, but with $\zeta_{0,y} = 0$ and $\zeta_{0,r} = 0$, and the shifter $f_{0,t}$ is given by
\begin{equation}
