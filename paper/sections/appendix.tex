...
\paragraph{Pricing the individual claims.} The princing condition for the dividend claim is given by
\begin{equation}
    \frac{1}{p_{k,t}} = r_t + \sigma_{R_k,t} \eta_t^\top - \big(\mu_{k,t} + \mu_{p_k,t} + \sigma_{k,t} \, \sigma_{p_k,t}^\top\big),
\end{equation}
where
\begin{equation}
    \mu_{p_{k,t}} = \frac{p_{k,X,t}}{p_{k,t}} \mu_{X,t} + \frac{1}{2}\sum_{k=1}^3 \sigma_{X,k,t}^\top\,\frac{p_{k,XX,t}}{p_{k,t}}\,\sigma_{X,k,t}, \qquad \qquad 
    \sigma_{p_{k,t}} = \frac{p_{k,X,t}}{p_{k,t}} \sigma_{X,t}.
\end{equation}
...
\begin{equation}
    \frac{1}{p_{D,0}} = r_0 + \sigma_{R_D,0} \eta_0^\top - \big(\mu_{D,0} + \mu_{p_D,0} + \sigma_{D,0} \, \sigma_{p_D,0}^\top\big),
\end{equation}
where
\begin{equation}
    \mu_{p_{D,0}} = \frac{p_{D,s,0}}{p_{D,0}} \mu_{s} + \frac{1}{2} \sigma_{X,1,0}^\top\,\frac{p_{D,XX,0}}{p_{D,0}}\,\sigma_{X,1,0}, \qquad \qquad 
    \sigma_{p_{D,0}} = \frac{p_{D,X,0}}{p_{D,0}} \sigma_{X,1,0}.
\end{equation}
