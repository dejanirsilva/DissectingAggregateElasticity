...
\section{Production and monetary policy}
...
\paragraph{Firm's problem.} As it is standard in the literature, we assume production is carried by a continuum of monopolistically competitive firms indexed by $i \in [0,1]$.
...
The problem of the firm is to maximize profits:
\begin{equation}
    \max_{L_{i,t}} P_{i,t} \tilde{Y}_{i,t} - \mathcal{W}_{i,t} L_{i,t},
\end{equation}
subject to the production function \eqref{eq:production_function} and the demand function:
\begin{equation}\label{eq:demand_function}
    \tilde{Y}_{i,t} = \left( \frac{P_{i,t}}{P_t} \right)^{-\phi} \tilde{Y}_t,
\end{equation}
where $P_t$ is the aggregate price level and $\phi$ is the elasticity of substitution between goods.

The first-order condition gives the labor demand:
\begin{equation}
    \mathcal{W}_{i,t} = (1-\alpha) A_t L_{i,t}^{-\alpha},
\end{equation}
...
\begin{equation}\label{eq:budget_constraint}
    \frac{d W_{j,t}}{W_{j,t}} = \left[r_t + \pi_{t}^\top \,\alpha_{j,t}  - \frac{\tilde{C}_{j,t} - \mathcal{W}_t L_{j,t}}{W_{j,t}}\right] dt 
    + \sigma_{j,t}\, dZ_t,
\end{equation}
...
\begin{equation}
    \frac{d W_{j,t}}{W_{j,t}} = \left[r_t + \pi_{t}^\top \,\alpha_{j,t}  - \frac{C_{j,t}}{W_{j,t}} + \frac{\mathcal{W}_t -\xi_t}{W_{j,t}} L_{j,t}\right] dt 
    + \sigma_{j,t}\, dZ_t.
\end{equation}
...
\begin{equation}
    L_t = \left(  \frac{1-\alpha}{\xi}\right)^{\frac{1}{\alpha}} \equiv \overline{L}.
\end{equation}
