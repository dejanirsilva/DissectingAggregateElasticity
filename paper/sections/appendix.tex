...
\begin{align}
    \frac{d \Lambda_t}{\Lambda_t} = -r^* dt - \gamma \sigma dZ_t, \qquad \qquad 
...
\begin{equation}
    p_{B,0}(X) = \frac{1}{\delta_D + \kappa_s}\left[1 + \frac{\kappa_s}{\delta_D}  \frac{1-\overline{s}}{1-s_t}  \right].
\end{equation}
...
\begin{equation}
    c_{j}(X,\epsilon) = \psi \rho + \left[ r + \pi_Y- \frac{\gamma_j}{2} \|\sigma\|^2 \right] + \mathcal{O}(\epsilon^2).
\end{equation}
