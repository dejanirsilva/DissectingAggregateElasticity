...
\end{equation}
Thus, equivalently,
\begin{align}\label{eq:delta-r2-alpha-p-compact}
    \Delta r_2
    &= -\psi^{-1}\Delta\mu_{y_Y,2}
...
When no leverage constraint binds, $\Delta\sigma_{j,2}$ for active investors is given by \eqref{eq:delta-sigma-j2-unconstrained-alpha-p}.
When the leverage constraint binds for investor $2$, $\Delta\eta_2$ and $\Delta\hat{\nu}_{2,2}$ are jointly determined by \eqref{eq:delta-eta2-constrained-system-alpha-p}, and $\Delta\sigma_{2,2}$ is given by \eqref{eq:delta-sigma-j2-constrained-alpha-p}.
