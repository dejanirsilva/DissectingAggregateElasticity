...
\begin{proof}
    ...
    Second, we show how to solve for the drift of the endogenous state variables, $\mu_{x_1,t}$ and $\mu_{x_2,t}$, in terms of $X_t$, $(c_j,p_Y)$ and their derivatives.
    ...
    \begin{equation}
        \sigma_{x_j} = x_{j} \left[ \sigma_{j} -  \sum_{k=0}^2 x_{k} \sigma_{x_k}  \right].
    \end{equation}
...
\begin{align}
    ...
    + (1-\psi^{-1}) \sum_{j=0}^2 x_{j} 
        \frac{\gamma_j \alpha_{j}^2}{2} \|\sigma_{R_Y}\|^2
    - \pi_{Y}.
\end{align}
