...
\paragraph{Risk exposure of active investors.} The risk exposure for the passive investor is given by
\begin{equation}
    \sigma_{0,1} = \hat{\alpha}_{p,1} \sigma. 
\end{equation}

The risk exposure for the first active investor is given by
\begin{equation}
    \sigma_{1,1} = \frac{\eta_1}{\gamma} - \frac{\eta_0}{\gamma} \hat{\gamma}_1.
\end{equation}
