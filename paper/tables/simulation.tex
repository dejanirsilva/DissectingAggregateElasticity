...
\begin{tabular}{@{}>{\raggedright\arraybackslash}p{0.65\linewidth}S[table-format=2.1]S[table-format=2.1]@{}}
    ...
    Return volatility (\%) & 19.6 & 18.5 \\
    Quarterly flows (\%) & 0.6 & 0.7 \\
    Price impact & 5.5 & 5.0 \\
    % Standard error (price impact) & 0.01 & \multicolumn{1}{c}{\textemdash} \\
    \midrule
    \multicolumn{3}{@{}l}{\textit{Panel B. Endowment-claim moments}} \\
    Risk premium (\%) & \PIYhat & \multicolumn{1}{c}{\textemdash} \\
    Return volatility (\%) & 4.12 & \multicolumn{1}{c}{\textemdash} \\
    Price impact & \PIYhat & \multicolumn{1}{c}{\textemdash} \\
    % Standard error (price impact) & 0.01 & \multicolumn{1}{c}{\textemdash} \\
    \midrule
